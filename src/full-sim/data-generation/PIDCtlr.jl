...
v_Ki = 0.6 #3.6
v_Kd = 1.61 #1.68
Kp = [2.0, v_Kp, v_Kp, v_Kp, arm_Kp, 4.59e-2, 2.23e-2, 6.3e-4] #, 20.]
Ki = [1., v_Ki, v_Ki, v_Ki, arm_Ki, 3.73e-1, 1.62e-1, 5.25e-3] #3.037e-6] #, .1]
Kd = [0.1, v_Kd, v_Kd, v_Kd, arm_Kd, 3.82e-3, 2.08e-3, 2.84e-5] #, .002]
